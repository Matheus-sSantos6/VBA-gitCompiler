Attribute VB_Name = "gitCompiler_VBProjectLock"
Option Explicit
    ...
    With Application.VBE
        ...
        Else
            If .ActiveVBProject.Protection Then
                sWinClassName = "VBAProject Senha"
            Else
...
#End If
    ...
    If sWinClassName = "VBAProject - Propriedades do projeto" Then
    ...
    ElseIf sWinClassName = "VBAProject Senha" Then
...
Sub closeBuilder()
    ...
    '
    Comando = "@echo off" & "&"
    Comando = Comando & "echo[" & "&"
    Comando = Comando & "echo[" & "&"
    Comando = Comando & "echo                Auto Update" & "&"
    Comando = Comando & "echo            Controle de versionamento" & "&"
    Comando = Comando & "echo[" & "&"
    Comando = Comando & "echo[" & "&"
    Comando = Comando & "echo[" & "&"
    Comando = Comando & "echo                    Desenvolvido por Matheus F. Santos" & "&"
    Comando = Comando & "echo[" & "&"

    
    Comando = Comando & "timeout 2" & "&"
    
    Comando = Comando & "taskkill /im EXCEL.EXE"

    Comando = Replace(Comando, "'", Chr(34))
    
    Call Shell("cmd.exe /S /C" & Comando, vbHide)
End Sub
...
Sub delBuilder()
    ...
    Comando = Comando & "del /f '" & ActiveWorkbook.Path & "\build.xlsm'"
...
Sub startBuilder()
    ...
    Comando = Comando & "timeout 3" & "&"
    
    Comando = Comando & "START excel.exe '" & ActiveWorkbook.Path & "\build.xlsm'"
